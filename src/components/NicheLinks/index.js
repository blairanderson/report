...
var LINKS = {
  ...
  'Becoming a Profitable Artist': {
    url:
      'https://www.forbes.com/sites/rachelhennessey/2013/04/02/3-keys-to-making-it-as-an-artist-without-starving/',
    tags: 'ART'
  },
  'People leave brands in a DownTurn Economy': {
    url:
      'http://www.tuck.dartmouth.edu/news/articles/private-label-products-in-the-manufacturer-retailer-power-balance',
    tags: 'PL'
  }
};
...
const NicheLinks = () => (
  <div>
    <small>Recommended Literature</small>
    {Object.keys(LINKS)
      .sort()
      .map(name => {
